...
\texttt{92} research publications
% \begin{sparkline}{4}
% \sparkspike .15 .36
% \sparkspike .3 .36
% \sparkspike .45 .45
...
\begin{sloppypar}
\noindent\years{2020} \textbf{Chad A.\ Steed}, John R.\ Goodall, Junghoon Chae, and Artem A.\ Trofimov. CrossVis: A Visual Analytics System for Exploring Heterogeneous Multivariate Data with Applications to Materials and Climate Sciences. \emph{Computers \& Graphics}, 2020 \textit{(In Press)}.\\
...
\begin{sloppypar}
\noindent\years{2020}``Oak Ridge's New VISTA Lab Aims for Data Viz Breakthroughs.'' HPCwire, May 2020,
...
\noindent\years{April 2020}``Visualizing COVID-19 Statistics on the Web'', Invited Talk for the ORNL CCSD COVID-19 Seminar Series, Oak Ridge, TN. Host: Becky Verastegui.\\
