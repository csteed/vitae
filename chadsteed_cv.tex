...
Data Science • Visual Analytics • Interactive Data Visualization • Machine
Learning • Cyber Security • Cyber Physical • Database Systems •
Climate Science • Text Mining • Computer Graphics • Generative Art • Graphic
Design

\section*{Technical Skills}
JavaScript • Node.js • D3.js • React.js • jQuery • Electron.js • Semantic UI • Python • Java • C/C++ • CSS • HTML • Lucene • Elasticsearch • HDF5 • NetCDF • SQL and NoSQL Databases • OpenGL • Git/SVN • Maven • LaTeX • Eclipse IDE • IntelliJ IDEA • Processing • Matlab • R • OmniGraffle • Adobe Creative Suite
...
\noindent\years{2010--present\\40 hrs/week}Senior Research Staff\\
Computational Data Analytics Group (Primary Appointment)\\
Computer Science and Mathematics Division\\
Multi-modal Data Analytics Group (Matrix Appointment)\\
...
\years{2018--present}Division Science Council\\
...
\texttt{91} research publications
% \begin{sparkline}{4}
% \sparkspike .15 .36
% \sparkspike .3 .36
% \sparkspike .45 .45
