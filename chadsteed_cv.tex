...
manufacturing, cyber security, power grid security, climate, materials science, text
mining, health care, and high performance computing.  I work between 40 and 50 hours per week.\\
\emph{\underline{Responsibilities}}: Conducting research and
...
geophysical, ambient noise, seafloor characterization, and unmanned vehicles. My work weeks varied from 40 to 50 hours.\\
...
Warfare Bottom Sediment Type (BST) database.  I worked 40 hours per week.
...
Java • JavaScript • Python • C/C++ • CSS • HTML • Lucene • Elasticsearch • HDF5 • NetCDF • SQL and NoSQL Databases • OpenGL • Git/SVN • Maven • D3.js • React.js • jQuery • LaTeX • Eclipse IDE • IntelliJ IDEA • Processing • Matlab • R • OmniGraffle • Adobe Creative Suite

\section*{Grants \amper{} Contracts}
\begin{sloppypar}
PI or Co-PI on \texttt{33} grants or contracts for a total of \$\texttt{13.1}M
% \begin{sparkline}{4}
% \sparkspike .083 10
% \sparkspike .25 .55
% \sparkspike .417 1
...
% \end{sparkline}
\\
Lead PI on \texttt{16} grants or contracts totaling \$\texttt{6.7}M\\
\\
\noindent\years{2017--2019}\emph{Principal Investigator}, ``SciDAC RAPIDS Task: Temporal and Multivariate Visual Analysis,'' DOE ASCR,
\$\texttt{200,000}.\\
