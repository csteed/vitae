...
Visual Analytics; Interactive Data Visualization; Data Science; Data
Analytics; Cyber Security; Additive Manufacturing; Text Mining; Computer
...
In addition to leading a team consisting of 12 researchers and engineers, I
...
Java; JavaScript; Python; C; C++; CSS; HTML; Lucene; Elasticsearch; HDF5;
NetCDF; OpenGL; Git; SVN; Maven; D3.js; React.js; jQuery; LaTeX; Eclipse IDE;
IntelliJ IDEA; Processing; ArcView GIS; Caris GIS; Matlab; R; OmniGraffle; Adobe
Illustrator; Adobe Photoshop

\section*{Grants \amper{} Contracts}
\begin{sloppypar}
PI \amper{} Co-PI on \texttt{31} grants or contracts for a total of \$\texttt{12.1}M
% \begin{sparkline}{4}
% \sparkspike .083 10
% \sparkspike .25 .55
% \sparkspike .417 1
...
% \end{sparkline}
\\
Lead PI on \texttt{13} grants or contracts totaling \$\texttt{5.8}M\\
\\
\noindent\years{2017--2018}\emph{Principal Investigator}, ``New Multi-modal Interactive Data Visualization Techniques for Scientific Data Analysis,'' ORNL Seed Project,
\$\texttt{190,000} (Co-PIs: John Goodall, Junghoon Chae, and Steven Hahn, ORNL).\\
\years{2016--2017}\emph{Investigator}, ``Cybersecurity Risk Information Sharing Program (CRISP),'' DOE,
\$\texttt{160,000} (\$\texttt{600,000} project total) (Lead PI: John Goodall, ORNL).\\
...
\begin{description}
  ...
  \item[Journal Reviewer:] ACM Trans.\ on Applied Perception (2016, 2017), Neurocomputing (2016), ACM Trans.\ on Interactive Intelligent Systems (2015), GeoInformatica (2015), IEEE Computer Graphics and Applications (2013),
