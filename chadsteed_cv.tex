...
\fancypagestyle{firststyle}
{
    ...
    %\rfoot{\small \today}
    \rfoot{\sffamily \small \thepage\ / \pageref{LastPage} • \today}
}

\fancyhf{}
%\lhead{\small Chad A. Steed, Ph.D.}
\rhead{\sffamily \small Chad A. Steed • Curriculum Vitae}
...
Visual Analytics; Interactive Data Visualization; Data Science; Cyber Security;
Additive Manufacturing; Human-computer Interaction;
Text Mining; Computer Graphics; Graphic Design
...
\noindent\years{2016}ORNL Best Director's Research \amper{} Development Poster Award\\
\years{2015}R\amper{}D 100 Award Finalist\\
...
\years{2013}R\amper{}D 100 Award\\
...
\begin{sloppypar}
PI \amper{} Co-PI on \texttt{29} grants or contracts for a total of \$\texttt{11.4}M
% \begin{sparkline}{4}
% \sparkspike .083 10
% \sparkspike .25 .55
% \sparkspike .417 1
...
% \end{sparkline}
\\
Lead PI on \texttt{12} grants or contracts totaling \$\texttt{5.7}M\\
\\
\noindent\years{2016--2017}\emph{Principal Investigator}, ``Visualization Science Advisor to ORNL's Spallation Neutron Source,'' ORNL SNS,
\$\texttt{75,000}.\\
\years{2015--2017}\emph{Investigator}, ``Data Analytics for Additive
Manufacturing,'' ORNL Manufacturing Demonstration Facility,
\$\texttt{200,000} (Lead PI: Ryan DeHoff, ORNL).\\
...
Description: A temporal visual analytics tool for interactive analysis of large and complex time series data.\\
...
\texttt{84} research publications
% \begin{sparkline}{4}
% \sparkspike .15 .36
% \sparkspike .3 .36
% \sparkspike .45 .45
...
\texttt{23} conference papers, \texttt{7} referred abstracts,
\texttt{19} workshop or position papers, \texttt{2} book
chapter, \texttt{25} technical reports, and \texttt{1} dissertation),
...
\subsection*{Referred Abstracts (\texttt{7})}

\noindent\years{2016}William Halsey, \textbf{Chad A. Steed}, Ryan Dehoff,
...
Vincent Paquit, and Sarah Powers. ORNL Technical Report ORNL/TM-2016/393,
...
Manurfacturing Defect Detection using Neural Networks}, Department of
...
\begin{description}
  ...
  \item[Journal Reviewer:] ACM Trans.\ on Applied Perception (2016), Neurocomputing (2016), ACM Trans.\ on Interactive Intelligent Systems (2015), GeoInformatica (2015), IEEE Computer Graphics and Applications (2013),
...
\begin{sloppypar}
\noindent\years{2016}``Doctoral Student Uses Internship to Improve Big Data
...
October 2011,
\href{http://blogs.knoxnews.com/munger/2011/10/so-thats-what-climate-change-l.html}{http://blogs.knoxnews.com/munger/2011/10/so-thats-what-climate-change-l.html}
\end{sloppypar}
...
\noindent\years{Oct.\ 2016}``Advancing Additive Manufacturing Through Visual
...
\noindent\years{2015--2016}Created and maintained website for
